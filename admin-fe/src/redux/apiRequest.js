...
export const loginUser = async(user, dispatch, navigate) => {
    dispatch(loginStart());
    try{
        const res = await axios.post("https://petshop-ktww.onrender.com/admin/auth/login", user);
...
export const registerUser = async(user, dispatch, navigate) =>{
    ...
    try{
        await axios.post("https://petshop-ktww.onrender.com/admin/auth/register", user);
...
export const logOut = async(dispatch, id, navigate, accessToken, axiosJWT) => {
    ...
    try{
        await axiosJWT.post("https://petshop-ktww.onrender.com/admin/auth/logout",id,{
